...
<section class="refusal-section"><div class="refusal-copy reveal"><div class="eyebrow"><b></b> Human-confirmed, never automatic</div><h2>Analysis is not an order.</h2><p>Reverb presents a deterministic recommendation with its arithmetic and source evidence. The final action stays with you; any supported execution is a separate, explicit Agent Hub handoff.</p><a class="text-link" href="{route('report', static)}">Inspect the morning brief <span>→</span></a></div><div class="refusal-card glass reveal delay-1"><div class="decision-stamp">FORWARD</div><span>Costco · event capture pending</span><strong>RCOSTUSDT</strong><p>The Costco workflow records the issuer timestamp, raw Reality book, reaction, and thesis reconciliation. A capture gap stays incomplete.</p><div class="math-line"><i style="--w:72%"></i><i style="--w:48%"></i></div><small>NVIDIA's 3% replay remains the secondary verification</small></div></section>
